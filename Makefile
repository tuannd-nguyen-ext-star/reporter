...
SRC:=$(GOPATH)/src/github.com/tuannd-nguyen-ext-star/reporter
...
.PHONY: buildlinux 
buildlinux: 	
	cmd //v //c "set GOOS=linux&&go install -v github.com/tuannd-nguyen-ext-star/reporter/cmd/grafana-reporter"
